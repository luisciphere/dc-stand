<?php
/*
 * Template Name: Продукция с 07.02.2016
 */?>
<?php get_header(); ?>
...
<div class="row somebrd marb45">
 ...
 echo '<div class="addimgsd"><table class="addimgs" align="center"><tr>';
		while (have_rows('cdimages', $prod->ID)){
			the_row(); 
			$cdimage = get_sub_field('cdimages-image');
			?>
   
			<td><a href="<?php echo $cdimage['sizes']['large'];?>" class="cbox secpic" rel="images<?php echo $prod->ID;?>"><img src="<?php echo $cdimage['sizes']['medium'];?>" /></a></td>
			<?php
		}
  echo '</tr></table></div>';
	} 
