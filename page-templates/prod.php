<?php
/*
 * Template Name: Продукция - старая версия 01-02-2016
 */?>
<?php get_header(); ?>
...
<div class="grid_9"><a name="<?php echo $prod->post_name; ?>"><h3 class="mart10"><?php echo $prod->post_title; ?></h3></a></div>
 ...
 <div class="grid_2" style="padding-top: 20px;">
      <section class="slider">
		<?php if( have_rows('cimages', $prod->ID) ): ?>
		<a href="#prev" class="sl-prev"><img src="<?php echo get_template_directory_uri(); ?>/images/arrtop.png" /></a>
		<div class="main-slider carousel">
			<ul class="slides">
				<?php	while ( have_rows('cimages', $prod->ID) ) : the_row(); 
				$img = get_sub_field('cimages-image');
				?>
				<li><a href="<?php echo $img['sizes']['large']; ?>" class="cbox" rel="images<?php echo $prod->ID;?>"><img src="<?php echo $img['sizes']['thumbnail']; ?>" style="height: 133px !important; width: auto !important; margin-left: auto; margin-right: auto;" /></a></li>
				<?php endwhile;?>
				<li><a href="<?php echo wp_get_attachment_url(get_post_thumbnail_id($prod->ID));?>" class="cbox" rel="images<?php echo $prod->ID;?>"><img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id($prod->ID));?>" style="height: 133px !important; width: auto !important; margin-left: auto; margin-right: auto;" /></a></li>
			</ul>
		</div>
		<a href="#next" class="sl-next"><img src="<?php echo get_template_directory_uri(); ?>/images/arrbot.png" /></a>
		<?php endif; ?>
		</section>
 </div>
 <div class="grid_4">
...
<div class="">
  ...
  <div class="ttup  marb20 clr13 fs20">С этим товаром покупают</div>
  <div class="marb45">
